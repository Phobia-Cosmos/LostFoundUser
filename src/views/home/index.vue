<template>
  <div class="main-content">
    <div style="width:80%;margin:0 auto ">
      ...
      <!--                <div style="flex:1;text-align: right; color: #666666 ;cursor: pointer"-->
      <!--                     @click="$router.push('/front/lostSquare')">查看更多-->
      <!--                </div>-->
      <!--              </div>-->
      ...
      <!--                          <div style="margin-top: 10px;color:#666666;font-size: 12px">发布人:{{ item.userName }}</div>-->
      <!--                          &lt;!&ndash;根据用户id关联一下找出用户名称&ndash;&gt;-->
      ...
      <!--                <div style="flex:1;text-align: right; color: #666666;cursor: pointer"-->
      <!--                     @click="$router.push('/front/findSquare')">查看更多-->
      <!--                </div>-->
      <!--              </div>-->
      <!--              <div style="margin-top: 30px">-->
      <!--                <el-row :gutter="20">-->
      ...
      <!--                    <div class="transition card">-->
      <!--                      <div style="display: flex">&lt;!&ndash;由于后台还没有设置好现在使用静态处理&ndash;&gt;-->
      <!--                        <img :src="item.img" alt=""-->
      <!--                             style="height: 75px; width: 75px;border: 1px solid #eeeeee;border-radius: 15px">-->
      <!--                        <div style="margin-left: 10px">-->
      <!--                          <div style="font-weight: 550;color: #0066BC">{{ item.name }}</div>-->
...
export default {
  ...
  methods: {
    ...
    // loadData() {
    //   this.$request.get('/user/v2/item/selectNew4').then(res => {
    //     if (res.code === 200) {
